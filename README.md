...
4. Note the name of your repository `URL` here: **<https://github.com/j143910/my-first-pr.git>**
...
```bash
git remote add origin https://github.com/j143910/my-first-pr.git
```
...
--- The pull operation doesn't have a separate URL because it uses the fetch URL to download changes and then merges them into your local branch.
